            ...
            <Card key={exec.id}>
              <View style={styles.approvalRow}>
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={styles.approvalChild}>por {getChildName(exec.assignment?.child?.name || 'Criança')}</Text>
                </View>
            ...
            <Card key={exec.id}>
              <View style={styles.approvalRow}>
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={styles.approvalChild}>para {getChildName(exec.assignment?.child?.name || 'Criança')}</Text>
                </View>
                <View style={styles.approvalActions}>
...
const styles = StyleSheet.create({
  ...
  approvalChild: { ...Typography.caption, marginTop: 2 },
